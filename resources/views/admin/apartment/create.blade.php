    ...
    <div class="container-fluid p-5">
        <div class="container p-5 shadow">
            <div class="mb-3 py-5 text-center">
                <h2 class="mb-3">Inserisci un nuovo appartamento</h2>
            </div>
            ...
            <form class="admin-form" id="form_submit" action="{{ route('admin.apartment.store') }}"
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 col-md-10 col-lg-8 mb-5">
                        <div class="row">
                            ...
                            <div class="col-7 me-5">
                                <label for="field_address" class="form-label"><b>Indirizzo</b></label>
                            ...
                            {{-- CITTA --}}
                            <div class="col">
                                <label for="field_city" class="form-label"><b>Città</b></label>
                    ...
                    {{-- IMMAGINE --}}
                    <div class="col-12 col-md-10 col-lg-8 mb-5">
                        <label for="field_cover_img" class="form-label"><b>Link Immagine</b></label>
                    ...
                    <div class="col-12 col-md-10 col-lg-8 mb-5 mb-md-0">
                        ...
                        <div class="row row-cols-2 row-cols-md-4 align-items-baseline">
                            {{-- STANZE --}}
                            <div class="col mb-5">
                                <label for="field_rooms" class="form-label"><b>N° Stanze</b></label>
                            ...
                            {{-- LETTI --}}
                            <div class="col">
                                <label for="field_beds" class="form-label"><b>N° Letti</b></label>
                                <input type="number" min="1" max="20"
                            ...
                            {{-- BAGNI --}}
                            <div class="col">
                                <label for="field_bathrooms" class="form-label"><b>N° Bagni</b></label>
                                <input type="number" min="1" max="20"
