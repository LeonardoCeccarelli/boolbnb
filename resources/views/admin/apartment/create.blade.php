...
<div class="container">
  ...
  <form id="form_submit" action="{{ route('admin.apartment.store') }}" enctype="multipart/form-data" method="POST"
    ...
    <div class="col-12 col-md-10 col-lg-8">
      ...
      <input type="text" class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city" id="field_city"
        value="{{ old('city') }}">
    </div>
    ...
    <div class="col-12 col-md-10 col-lg-8">
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xl-5 g-3">
        ...
        <div class="col">
          ...
          <input type="number" min="1" max="20" class="form-control {{ $errors->has('bathrooms') ? 'is-invalid' : ''}}"
