      ...
      <form action="{{ route('admin.apartment.update', $apartment->id) }}" enctype="multipart/form-data" method="POST"
        ...
        <div class="col-12 col-md-10 col-lg-8">
          ...
          <input type="file" class="form-control {{ $errors->has('cover_img') ? 'is-invalid' : '' }}" name="cover_img"
            id="field_cover_img" value="{{ old('cover_img') ?? $apartment->cover_img }}">
        ...
        <div class="col-12 col-md-10 col-lg-8">
          ...
          <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xl-5 g-3">
            <div class="col">
              ...
              <input type="number" min="1" max="20" class="form-control {{ $errors->has('rooms') ? 'is-invalid' : '' }}"
            ...
            <div class="col">
              ...
              <input type="number" min="1" max="20" class="form-control {{ $errors->has('beds') ? 'is-invalid' : '' }}"
                name="beds" id="field_beds" value="{{ old('beds') ?? $apartment->beds }}">
            ...
            <div class="col">
              ...
              <input type="number" min="1" max="300"
                ...
                id="field_square_metres" value="{{ old('square_metres') ?? $apartment->square_metres }}">
